  ...
  return (
    ...
    >
      ...
      >
        {items.map((item, idx) => (
          <li
            className=" dark:text-white dark:bg-black white:bg-white white:text-black w-[450px] max-w-full relative rounded-2xl border border-b-2 flex-shrink-0 border-gray px-8 py-6 md:w-[450px]"
            style={{
              background:
                "black",
            }}
